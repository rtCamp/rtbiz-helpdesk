...
global $wpdb, $rtbiz_hd_contacts, $rtbiz_hd_accounts;
	...
	<table class="wp-list-table widefat fixed">
		...
		foreach ( $example_data as $rslt ) {
			...
			<tr>
				...
				<td>
					<?php
					$post_terms   = rtbiz_get_post_for_contact_connection( $rslt->ID, $rslt->post_type, $fetch_contact = true );
				...
				<td>
					<?php
					$post_terms   = rtbiz_get_post_for_company_connection( $rslt->ID, $rslt->post_type, $fetch_company = true );
					$account_name = rtbiz_get_company_post_type();
