	...
	public function get_settings() {
		...
		$settings = apply_filters( 'rtbiz_hd_notification_email_settings', array(
			...
			array(
				...
				'id'            => 'rthd_notification_acl_client_events_new_ticket_created_mail',
				'default'       => 'yes',
				'type'          => 'checkbox',
				'checkboxgroup' => 'start',
				'autoload'      => true
			...
			array(
				...
				'id'            => 'rthd_notification_acl_client_events_new_followup_created_mail',
				'default'       => 'yes',
				'type'          => 'checkbox',
				'checkboxgroup' => '',
				'autoload'      => true
			...
			array(
				...
				'id'            => 'rthd_notification_acl_client_events_new_followup_updated_mail',
				'default'       => 'no',
				'type'          => 'checkbox',
				'checkboxgroup' => '',
				'autoload'      => true
			...
			array(
				'desc'          => __( 'When any follow-up is edited by staff', RTBIZ_HD_TEXT_DOMAIN ),
				'id'            => 'rthd_notification_acl_client_events_new_followup_deleted_mail',
				'default'       => 'no',
				'type'          => 'checkbox',
				'checkboxgroup' => 'end',
				'autoload'      => true
			...
			array(
				...
				'desc'          => __( 'When a customer creates a ticket via the web form or email', RTBIZ_HD_TEXT_DOMAIN ),
				'id'            => 'rthd_notification_acl_assignee_events_new_ticket_created_mail',
				'default'       => 'yes',
				'type'          => 'checkbox',
				'checkboxgroup' => 'start',
				'autoload'      => true
			...
			array(
				'desc'          => __( 'When a new follow-up is added to a ticket', RTBIZ_HD_TEXT_DOMAIN ),
				'id'            => 'rthd_notification_acl_assignee_events_new_followup_created_mail',
				'default'       => 'yes',
				'type'          => 'checkbox',
				'checkboxgroup' => '',
				'autoload'      => true
			...
			array(
				...
				'id'            => 'rthd_notification_acl_assignee_events_new_followup_updated_mail',
				'default'       => 'yes',
				'type'          => 'checkbox',
				'checkboxgroup' => '',
				'autoload'      => true
			...
			array(
				...
				'id'            => 'rthd_notification_acl_assignee_events_new_followup_deleted_mail',
				'default'       => 'yes',
				'type'          => 'checkbox',
				'checkboxgroup' => '',
				'autoload'      => true
			...
			array(
				...
				'id'            => 'rthd_notification_acl_assignee_events_ticket_reassigned_mail',
				'default'       => 'yes',
				'type'          => 'checkbox',
				'checkboxgroup' => '',
				'autoload'      => true
			...
			array(
				...
				'id'            => 'rthd_notification_acl_assignee_events_new_staff_only_followup_created_mail',
				'default'       => 'yes',
				'type'          => 'checkbox',
				'checkboxgroup' => '',
				'autoload'      => true
			...
			array(
				...
				'id'            => 'rthd_notification_acl_assignee_events_ticket_updated_mail',
				'default'       => 'yes',
				'type'          => 'checkbox',
				'checkboxgroup' => '',
				'autoload'      => true
			...
			array(
				...
				'id'            => 'rthd_notification_acl_assignee_events_new_subscriber_added_mail',
				'default'       => 'no',
				'type'          => 'checkbox',
				'checkboxgroup' => '',
				'autoload'      => true
			...
			array(
				...
				'id'            => 'rthd_notification_acl_assignee_events_subscriber_removed_mail',
				'default'       => 'no',
				'type'          => 'checkbox',
				'checkboxgroup' => 'end',
				'autoload'      => true
			...
			array(
				...
				'desc'          => __( 'When a customer creates a ticket via the web form or email', RTBIZ_HD_TEXT_DOMAIN ),
				'id'            => 'rthd_notification_acl_staff_events_new_ticket_created_mail',
				'default'       => 'yes',
				'type'          => 'checkbox',
				'checkboxgroup' => 'start',
				'autoload'      => true
			...
			array(
				'desc'          => __( 'When a new follow-up is added to a ticket', RTBIZ_HD_TEXT_DOMAIN ),
				'id'            => 'rthd_notification_acl_staff_events_new_followup_created_mail',
				'default'       => 'yes',
				'type'          => 'checkbox',
				'checkboxgroup' => '',
				'autoload'      => true
			...
			array(
				'desc'          => __( 'When a follow-up is edited by staff/customer', RTBIZ_HD_TEXT_DOMAIN ),
				'id'            => 'rthd_notification_acl_staff_events_new_followup_updated_mail',
				'default'       => 'yes',
				'type'          => 'checkbox',
				'checkboxgroup' => '',
				'autoload'      => true
			...
			array(
				'desc'          => __( 'When a follow-up is deleted by staff/customer', RTBIZ_HD_TEXT_DOMAIN ),
				'id'            => 'rthd_notification_acl_staff_events_new_followup_deleted_mail',
				'default'       => 'yes',
				'type'          => 'checkbox',
				'checkboxgroup' => '',
				'autoload'      => true
			...
			array(
				'desc'          => __( 'When a ticket is reassigned', RTBIZ_HD_TEXT_DOMAIN ),
				'id'            => 'rthd_notification_acl_staff_events_ticket_reassigned_mail',
				'default'       => 'yes',
				'type'          => 'checkbox',
				'checkboxgroup' => '',
				'autoload'      => true
			...
			array(
				'desc'          => __( 'When a staff-only follow-up is added/edited on a ticket', RTBIZ_HD_TEXT_DOMAIN ),
				'id'            => 'rthd_notification_acl_staff_events_new_staff_only_followup_created_mail',
				'default'       => 'yes',
				'type'          => 'checkbox',
				'checkboxgroup' => '',
				'autoload'      => true
			...
			array(
				'desc'          => __( 'When any status or metadata changed for a ticket', RTBIZ_HD_TEXT_DOMAIN ),
				'id'            => 'rthd_notification_acl_staff_events_ticket_updated_mail',
				'default'       => 'yes',
				'type'          => 'checkbox',
				'checkboxgroup' => '',
				'autoload'      => true
			...
			array(
				'desc'          => __( 'When a staff member subscribes to a ticket', RTBIZ_HD_TEXT_DOMAIN ),
				'id'            => 'rthd_notification_acl_staff_events_new_subscriber_added_mail',
				'default'       => 'no',
				'type'          => 'checkbox',
				'checkboxgroup' => '',
				'autoload'      => true
			...
			array(
				'desc'          => __( 'When a subscriber is removed from a ticket', RTBIZ_HD_TEXT_DOMAIN ),
				'id'            => 'rthd_notification_acl_staff_events_subscriber_removed_mail',
				'default'       => 'no',
				'type'          => 'checkbox',
				'checkboxgroup' => 'end',
				'autoload'      => true
