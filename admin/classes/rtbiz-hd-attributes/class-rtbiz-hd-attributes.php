...
if ( ! class_exists( 'Rtbiz_HD_Attributes' ) ) {
	...
	class Rtbiz_HD_Attributes {
		...
		public function __construct() {
			global $rtbiz_hd_rt_attributes, $rtbiz_hd_attributes_model, $rtbiz_hd_attributes_relationship_model;
			$rtbiz_hd_rt_attributes                 = new RT_Attributes( RTBIZ_HD_TEXT_DOMAIN );
			...
			Rtbiz_HD::$loader->add_action( 'init', $this, 'init_attributes' );
		}
