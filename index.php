...
function rt_hd_include() {
	...
	global $rthd_app_autoload, $rthd_admin_autoload, $rthd_admin_meta_box_autoload, $rthd_models_autoload, $rthd_helper_autoload, $rthd_form_autoload, $rthd_reports_autoload;
	$rthd_app_autoload = new RT_WP_Autoload( RT_HD_PATH_APP );
	$rthd_admin_autoload = new RT_WP_Autoload( RT_HD_PATH_ADMIN );
	$rthd_admin_meta_box_autoload = new RT_WP_Autoload( RT_HD_PATH_ADMIN . 'meta-box/' );
