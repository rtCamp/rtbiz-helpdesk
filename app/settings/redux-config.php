						...
						<td>
							...
							<?php if( $ac->type == 'imap' ) { ?>
								...
								<tr valign="top">
									...
									<td class="long"><input required="required" autocomplete="off" type="password" name="imap_password" placeholder="Password" value="<?php echo rthd_encrypt_decrypt( $token ); ?>" /></td>
								</tr>
							<?php }
								$all_folders = NULL;
								try {
								...
								<tr valign="top">
									...
									<td>
										<label> <?php _e( 'Inbox Folder' ); ?>
											<select data-email-id="<?php echo $ac->id; ?>" name="inbox_folder" data-prev-value="<?php echo $inbox_folder; ?>">
