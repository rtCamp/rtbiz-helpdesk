		...
		public function set_sections() {
			...
			$general_fields = array(
				...
				array(
					...
					'desc'     => __( 'If enabled, this will generate a unique Hash URL for all the tickets through which tickets can be accessed in the front end. This unique URLs will be sent in all emails of Helpdesk. Tickets can be accessed from the default WordPress permalinks as well. Please flush the permalink after enabling this option.' ),
					'default'  => false,
					'on'       => __( 'Enable' ),
					'off'      => __( 'Disable' ),
				),
