    ...
    class Rt_HD_Edd_License {
        ...
        function __construct() {
            ...
            if ( ! class_exists( 'EDD_SL_Plugin_Updater' ) ) {
                ...
                include_once( RT_HD_PATH_VENDOR . 'edd-license/class-edd-sl-plugin-updater.php' );
            }
                        ...
                        <table class="form-table">
                            ...
                            <tr valign="top">
                                <th scope="row" valign="top">
                                    <?php _e('License Key', RT_HD_TEXT_DOMAIN ); ?>
                                </th>
                                <td>
                            ...
                            <?php if (false !== $license) { ?>
                                <tr valign="top">
                                    <th scope="row" valign="top">
                                        <?php _e('Activate / Deactivate License', RT_HD_TEXT_DOMAIN ); ?>
                                    </th>
                                    <td>
                                        <?php if ($status !== false && $status == 'valid') { ?>
                                            ...
                                            <input type="submit" class="button-secondary"
                                                   ...
                                                   value="<?php _e('Deactivate License', RT_HD_TEXT_DOMAIN ); ?>"/>
                                        <?php
                                        } else {
                                            wp_nonce_field('edd_rthelpdesk_nonce', 'edd_rthelpdesk_nonce'); ?>
                                            <input type="submit" class="button-secondary"
                                                   name="edd_rthelpdesk_license_activate"
                                                   value="<?php _e('Activate License', RT_HD_TEXT_DOMAIN ); ?>"/>
                                        <?php } ?>
                                    </td>
                                </tr>
                            <?php } ?>
        ...
        function edd_sample_activate_license() {
            ...
            if ( isset( $_POST['edd_rthelpdesk_license_activate'] ) ) {
                ...
                $api_params = array(
                    'edd_action' => 'activate_license', 'license' => $license, 'item_name' => urlencode( EDD_RT_HELPDESK_ITEM_NAME ), // the name of our product in EDD
                    'url' => home_url(),
                );
        ...
        function edd_sample_deactivate_license() {
            ...
            if ( isset( $_POST['edd_rthelpdesk_license_deactivate'] ) ) {
                ...
                // data to send in our API request
                $api_params = array(
                    'edd_action' => 'deactivate_license', 'license' => $license, 'item_name' => urlencode( EDD_RT_HELPDESK_ITEM_NAME ), // the name of our product in EDD
                    'url' => home_url(),
                );
        ...
        function edd_sample_check_license() {
            ...
            $api_params = array(
                'edd_action' => 'check_license', 'license' => $license, 'item_name' => urlencode( EDD_RT_HELPDESK_ITEM_NAME ), 'url' => home_url(),
            );
