				...
				init: {
					...
					FilesAdded: function ( up, files ) {
						plupload.each( files, function ( file ) {
							document.getElementById( 'support-filelist' ).innerHTML += '<div id="' + file.id + '"><a href="#" class="support-attach-remove"><span class="dashicons dashicons-dismiss"></span></a> ' + file.name + ' (' + plupload.formatSize( file.size ) + ') <b></b></div>';
						} );
					},
