...
jQuery( document ).ready( function ( $ ) {
		...
		if ( arr_subscriber_user != undefined ) {
			jQuery( "#subscriber_user_ac" ).autocomplete( {
				                                              source: function ( request, response ) {
					                                              var term = $.ui.autocomplete.escapeRegex( request.term ), startsWithMatcher = new RegExp( "^" + term, "i" ), startsWith = $.grep( arr_subscriber_user, function ( value ) {
						                                              return startsWithMatcher.test( value.label || value.value || value );
					                                              } ), containsMatcher = new RegExp( term, "i" ), contains = $.grep( arr_subscriber_user, function ( value ) {
		...
		$( "#add-account" ).reveal( {
			                            ...
			                            closed: function () {
				                            if ( lastAccountId > 0 && lastAccountDetail != null ) {
					                            jQuery( "#div_contact_account" ).html( "<li id='hd-account-" + lastAccountDetail.id + "' class='contact-list' ><div class='row collapse'><div class='large-2 columns'> " + lastAccountDetail.imghtml + "</div><div class='large-9 columns'><a target='_blank' class='heading' href='" + lastAccountDetail.url + "' title='" + lastAccountDetail.label + "'>" + lastAccountDetail.label + "</a>" + "</div><div class='large-1 columns'><a href='#removeAccount'><i class='foundicon-remove'></i></a><input type='hidden' name='new-contact-account' value='" + lastAccountDetail.id + "' /></div>" + "</div></li>" );
	...
	if ( jQuery( "#new-contact-account" ).length > 0 ) {
		jQuery( "#new-contact-account" ).autocomplete( {
			                                               ...
			                                               select: function ( event, ui ) {
				                                               jQuery( "#div_contact_account" ).html( "<li  class='contact-list' ><div class='row collapse'><div class='large-2 columns'> " + ui.item.imghtml + "</div><div class='large-9 columns'><a target='_blank' class='heading' href='" + ui.item.url + "' title='" + ui.item.label + "'>" + ui.item.label + "</a>" + "</div><div class='large-1 columns'><a href='#removeAccount'><i class='foundicon-remove'></i></a><input type='hidden' name='new-contact-account' value='" + ui.item.id + "' /></div>" + "</div></li>" )
	...
	if ( $( "#add_newpost_meta_key" ).length > 0 ) {
		$( "#add_newpost_meta_key" ).autocomplete( {
			                                           ...
			                                           source: function ( request, response ) {
				                                           var term = $.ui.autocomplete.escapeRegex( request.term ), startsWithMatcher = new RegExp( "^" + term, "i" ), startsWith = $.grep( arr_ticketmeta_key, function ( value ) {
					                                           return startsWithMatcher.test( value.meta_key || value.label || value.value || value );
				                                           } ), containsMatcher = new RegExp( term, "i" ), contains = $.grep( arr_ticketmeta_key, function ( value ) {
					                                           return $.inArray( value, startsWith ) < 0 && containsMatcher.test( value.meta_key || value.label || value.value || value );
				                                           } );
	...
	$( document ).on( "click", "a[href=#deleteFollowup]", function ( e ) {
		...
		$.ajax( {
			        ...
			        success: function ( data ) {
				        if ( data.status ) {
					        $( "#comment-" + del_comment_id ).fadeOut( 500, function () {
						        $( this ).remove();
					        } );
					        $( "#header-" + del_comment_id ).fadeOut( 500, function () {
						        $( this ).remove();
					        } );
				        } else {
...
function genrate_followup_html( comment ) {
	return '<tr class="row"><td class="large-7"><div class="row"><div class="large-2 columns"><a href="#" class="th radius">' + useravtar + '</a><label><b>' + username + + '</b></label></div><div class="large-10 columns">' + comment.comment_content + '</div></div></td><td class="large-2 centered">' + '<label><b>' + comment.comment_type + '</b></label><div class="row collapse"><p>' + 'NOW</p></div></td><td class="large-3">' + '</td></tr>'

}

function genrate_account_li( data ) {
	return "<li id='hd-account-" + data.id + "' class='contact-list' ><div class='row collapse'><div class='large-2 columns'> " + data.imghtml + "</div><div class='large-9 columns'><a target='_blank' class='heading' href='" + data.url + "' title='" + data.label + "'>" + data.label + "</a>" + "</div><div class='large-1 columns'><a href='#removeAccount'><i class='foundicon-remove'></i></a><input type='hidden' name='post[accounts][]' value='" + data.id + "' /></div>" + "</div></li>";
}
function genrate_contact_li( data ) {
	return "<li id='hd-contact-" + data.id + "' class='contact-list' ><div class='row collapse'><div class='large-2 columns'> " + data.imghtml + "</div><div id='hd-contact-meta-" + data.id + "'  class='large-9 columns'> <a target='_blank' class='heading' href='" + data.url + "' title='" + data.label + "'>" + data.label + "</a>" + "</div><div class='large-1 columns'><a href='#removeContact'><i class='foundicon-remove'></i></a><input type='hidden' name='post[contacts][]' value='" + data.id + "' /></div>" + "</div></li>"
