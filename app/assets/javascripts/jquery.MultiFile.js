...
if (window.jQuery)(function ($) {
		...
		this
			...
			.each(function () {
				      ...
				      if (!MultiFile.list) {
					      ...
					      MultiFile.wrapper.append('<div class="MultiFile-list" id="' + MultiFile.wrapID + '_list"></div><a href="#" style="display: none;" class="rthd-clear-all-files">clear files</a>');
	...
	$(document ).on('click','.rthd-clear-all-files', function(e) {
		e.preventDefault();
		$('input[type="file"]').MultiFile('reset');
		$('.rthd-clear-all-files' ).hide();
	});
