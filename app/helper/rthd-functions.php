						...
						<div id="spread-the-word" class="postbox">
							...
							<div class="inside">
								<div class="rthd-social-share" id="social">
											...
											<p><a href="' . sprintf( '%s', 'https://rtcamp.com/feed/' ) . '"  title="' . __( 'Subscribe to our feeds', RT_HD_TEXT_DOMAIN ) . '" class="button" target="_blank" title="' . __( 'Subscribe to our Feeds', RT_HD_TEXT_DOMAIN ) . '">' . __( 'Subscribe to our Feeds', RT_HD_TEXT_DOMAIN ) . '<span class="dashicons dashicons-rss"></span></a></p>
										</div>
									</div>
								</div>';
