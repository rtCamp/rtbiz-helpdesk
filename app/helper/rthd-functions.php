		...
		<div id="spread-the-word" class="postbox">
			...
			<div class="inside">
				<div class="rthd-social-share" id="social">
					<p><a href="<?php echo 'http://twitter.com/home/?status=' . $message; ?>" class="button twitter" target= "_blank" title="<?php _e( 'Post to Twitter Now', RT_HD_TEXT_DOMAIN ) ?>"><?php _e( 'Post to Twitter', RT_HD_TEXT_DOMAIN ) ?><span class="dashicons dashicons-twitter"></span></a></p>
