...
function rthd_admin_notice_dependency_installed() {
	...
	if ( ! empty( $string ) ) {
		...
		<div class="updated">
			<p>
		<?php echo $string; ?>
				<a class="welcome-panel-close" style="margin-left: 10px" href="<?php echo esc_url( admin_url( 'edit.php?post_type=rtbiz_hd_ticket&page=rthd-setup-wizard&close_notice=true' ) ); ?>">Dismiss</a>
			</p>
		</div>
				<?php
			}
