	...
	class RT_Ticket_Diff_Email {
		...
		public static function store_old_post_data( $post_id, $post ) {
			...
			if ( $diff ) {
				...
				$id = $rt_hd_ticket_history_model->insert( array( 'ticket_id' => $post_id, 'type' => 'post_status', 'old_value' => $oldpost->post_status, 'new_value' => $_POST[ 'post_status' ], 'update_time' => current_time( 'mysql' ), 'updated_by' => get_current_user_id(), ) );
