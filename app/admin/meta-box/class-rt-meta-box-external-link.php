    ...
    class RT_Meta_Box_External_Link {
        ...
        public static function ui( $post ) {
            ...
            <div id="external-files-container"><?php
                if ( isset( $post->ID ) ) {
                    $ticket_ex_files = get_post_meta( $post->ID, '_rtbiz_helpdesk_ticket_external_file' );
                    $count = 1;
        ...
        public static function save( $post_id, $post ) {
            ...
            if ( isset( $_POST['ticket_ex_files'] ) ) {
                    ...
                    delete_post_meta( $post_id, '_rtbiz_helpdesk_ticket_external_file' );
                    ...
                    foreach ( $new_ex_files as $ex_file ) {
                            ...
                            add_post_meta( $post_id, '_rtbiz_helpdesk_ticket_external_file', json_encode( $ex_file ) );
                    }
            } else {
                    delete_post_meta( $post_id, '_rtbiz_helpdesk_ticket_external_file' );
            }
