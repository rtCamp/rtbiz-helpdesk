...
if ( ! class_exists( 'Rt_HD_Closing_Reason' ) ) {
	class Rt_HD_Closing_Reason {
		...
		function closing_reason( $post_type ) {
			$labels     = array( 'name' => __( 'Closing Reason', RT_HD_TEXT_DOMAIN ), 'search_items' => __( 'Search Closing Reason', RT_HD_TEXT_DOMAIN ), 'all_items' => __( 'All Closing Reasons', RT_HD_TEXT_DOMAIN ), 'edit_item' => __( 'Edit Closing Reason', RT_HD_TEXT_DOMAIN ), 'update_item' => __( 'Update Closing Reason', RT_HD_TEXT_DOMAIN ), 'add_new_item' => __( 'Add New Closing Reason', RT_HD_TEXT_DOMAIN ), 'new_item_name' => __( 'New Closing Reason', RT_HD_TEXT_DOMAIN ), 'menu_name' => __( 'Closing Reasons', RT_HD_TEXT_DOMAIN ), 'choose_from_most_used' => __( 'Choose from the most used Closing Reasons', RT_HD_TEXT_DOMAIN ), );
			$editor_cap = rt_biz_get_access_role_cap( RT_HD_TEXT_DOMAIN, 'editor' );
			register_taxonomy( rthd_attribute_taxonomy_name( 'closing-reason' ), array( $post_type ), array( 'hierarchical' => false, 'labels' => $labels, 'show_ui' => true, 'query_var' => true, 'update_count_callback' => 'rthd_update_post_term_count', 'rewrite' => array( 'slug' => rthd_attribute_taxonomy_name( 'closing-reason' ) ), 'capabilities' => array( 'manage_terms' => $editor_cap, 'edit_terms' => $editor_cap, 'delete_terms' => $editor_cap, 'assign_terms' => $editor_cap, ), ) );
		}
