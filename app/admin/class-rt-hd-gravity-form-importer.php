...
if ( ! class_exists( 'Rt_HD_Gravity_Form_Importer' ) ) {
	...
	class Rt_HD_Gravity_Form_Importer {
		...
		function init_importer() {
			...
			$this->ticket_field = array( "title" => array( 'display_name' => 'Title', 'slug' => 'title', 'required' => false, 'multiple' => false, 'type' => 'any' ), "description" => array( 'display_name' => 'Description', 'slug' => 'description', 'required' => true, 'multiple' => false, 'type' => 'any' ), "ticketmeta" => array( 'display_name' => 'Ticket Meta', 'slug' => 'ticketmeta', 'required' => false, 'multiple' => true, 'type' => 'key', 'key_list' => 'arr_ticketmeta_key' ), "creationdate" => array( 'display_name' => 'Create Date', 'slug' => 'creationdate', 'required' => false, 'multiple' => false, 'type' => 'date' ), "modifydate" => array( 'display_name' => 'Last Modify Date', 'slug' => 'modifydate', 'required' => false, 'multiple' => false, 'type' => 'date' ), "assignedto" => array( 'display_name' => 'Assigne To', 'slug' => 'assignedto', 'required' => false, 'multiple' => false, 'type' => 'defined', 'definedsource' => 'arr_assignedto' ), "ticketstatus" => array( 'display_name' => 'Status', 'slug' => 'ticketstatus', 'required' => true, 'multiple' => false, 'type' => 'defined', 'definedsource' => 'arr_ticketstatus' ), );
			...
			foreach ( $attributes as $attr ) {
				...
				$this->ticket_field[ $slug ] = array( 'display_name' => $attr->attribute_label, 'slug' => $slug, 'required' => ( isset( $attr_settings[ 'is_required' ] ) && $attr_settings[ 'is_required' ] == 'yes' ) ? true : false, );
			...
			if ( isset( $module_settings[ 'attach_contacts' ] ) && $module_settings[ 'attach_contacts' ] == 'yes' ) {
				$temp_arr           = array( "contactname" => array( 'display_name' => 'Contact Name', 'slug' => 'contactname', 'required' => false, 'multiple' => false, 'type' => 'text' ), "contactfirstname" => array( 'display_name' => 'Contact First Name', 'slug' => 'contactfirstname', 'required' => false, 'multiple' => false, 'type' => 'text' ), "contacttitle" => array( 'display_name' => 'Contact Title', 'slug' => 'contacttitle', 'required' => false, 'multiple' => false, 'type' => 'text' ), "contactlastname" => array( 'display_name' => 'Contact Last Name', 'slug' => 'contactlastname', 'required' => false, 'multiple' => false, 'type' => 'text' ), "contactaddress" => array( 'display_name' => 'Contact Address', 'slug' => 'contactaddress', 'required' => false, 'multiple' => false, 'type' => 'text' ), "contactemail" => array( 'display_name' => 'Contact Email', 'slug' => 'contactemail', 'required' => true, 'multiple' => true, 'type' => 'email' ), "contactskypeid" => array( 'display_name' => 'Contact Skype Id', 'slug' => 'contactskypeid', 'required' => false, 'multiple' => true, 'type' => 'text' ), "contactphoneno" => array( 'display_name' => 'Contact Phone No', 'slug' => 'contactphoneno', 'required' => false, 'multiple' => true, 'type' => 'text' ), "contactmeta" => array( 'display_name' => 'Contact Meta', 'slug' => 'contactmeta', 'required' => false, 'multiple' => true, 'type' => 'any' ), );
			...
			if ( isset( $module_settings[ 'attach_accounts' ] ) && $module_settings[ 'attach_accounts' ] == 'yes' ) {
				$temp_arr           = array( "accountname" => array( 'display_name' => 'Account Name', 'slug' => 'accountname', 'required' => false, 'multiple' => false, 'type' => 'any' ), "accountaddress" => array( 'display_name' => 'Account Address', 'slug' => 'accountaddress', 'required' => false, 'multiple' => false, 'type' => 'any' ), "accountcountry" => array( 'display_name' => 'Account Country', 'slug' => 'accountcountry', 'required' => false, 'multiple' => false, 'type' => 'any' ), "accountmeta" => array( 'display_name' => 'Account Meta', 'slug' => 'accountmeta', 'required' => false, 'multiple' => true, 'type' => 'any' ), );
				$this->ticket_field = array_merge( $this->ticket_field, $temp_arr );
			}
		}
		...
		public function importer() {
			...
			if ( $_REQUEST[ "type" ] == "csv" ) {
				...
				<div id="map_message" class="updated map_message">
					Form Selected : <strong><?php echo $form_data[ "title" ]; ?></strong><br/> Total Entries:
					<strong><?php echo $form_count[ "total" ]; ?></strong>
				</div>
				<form method="post" action="" id="rtHelpdeskMappingForm" name="rtHelpdeskMappingForm">
			...
			foreach ( $attributes as $attr ) {
				...
				<tr>
					...
					<td>
						...
						switch ( $attr->attribute_store_as ) {
							case 'taxonomy':
								$attr_terms = get_terms( rthd_attribute_taxonomy_name( $attr->attribute_name ), array( "hide_empty" => false, "orderby" => $attr->attribute_orderby, "order" => "ASC" ) );
								$term_array = array();
		...
		public function rthd_map_import_feauture() {
			...
			if ( ! isset( $_REQUEST[ "map_form_id" ] ) ) {
				...
				if ( ! empty( $mapping ) ) {
					...
					$data = array( 'form_id' => $form_id, 'mapping' => $map_data, );
