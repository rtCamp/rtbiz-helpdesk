...
if (!class_exists('Rt_HD_Module')) {
	class Rt_HD_Module
	{
		...
		function edit_custom_columns($columns)
		{
			...
			$columns['author'] = __('Assignee', RT_HD_TEXT_DOMAIN);
		...
		function manage_custom_columns($column)
		{
			...
			switch ($column) {
				...
				case 'rthd_create_date' :
					...
					echo human_time_diff($date->format('U'), time()) . __(' ago', RT_HD_TEXT_DOMAIN );
		...
		function tickets_by_status()
		{
			...
			$rt_hd_dashboard->charts[] = array(
				...
				'options' => array(
					'title' => __('Status wise Tickets', RT_HD_TEXT_DOMAIN ),
				),
			);
			?>
		...
		function team_load()
		{
			...
			$cols[] = array(
				'type' => 'string',
				'label' => __('Users', RT_HD_TEXT_DOMAIN ),
			);
			...
			$rt_hd_dashboard->charts[] = array(
				...
				'options' => array(
					'title' => __('Team Load', RT_HD_TEXT_DOMAIN ),
				),
			);
			?>
		...
		function top_accounts()
		{
			...
			$cols = array(
				array(
					'type' => 'string',
					'label' => __('Account Name', RT_HD_TEXT_DOMAIN ),
				),
				array(
					'type' => 'number',
					'label' => __('Number of Tickets', RT_HD_TEXT_DOMAIN ),
				),
			);
			...
			$rt_hd_dashboard->charts[] = array(
				...
				'options' => array(
					'title' => __('Top Accounts', RT_HD_TEXT_DOMAIN ),
				),
			);
			?>
		...
		function top_clients()
		{
			...
			$cols = array(
				array(
					'type' => 'string',
					'label' => __('Contact Name', RT_HD_TEXT_DOMAIN ),
				),
				array(
					'type' => 'number',
					'label' => __('Number of Tickets', RT_HD_TEXT_DOMAIN ),
			...
			$rt_hd_dashboard->charts[] = array(
				...
				'options' => array(
					'title' => __('Top Clients', RT_HD_TEXT_DOMAIN ),
				),
			);
			?>
