...
if ( ! class_exists( 'Rt_HD_Attributes' ) ) {
	...
	class Rt_HD_Attributes {
		...
		function render_dropdown( $attr, $options ) {
			global $rthd_form;
			$args = array( 'id'             => $attr->attribute_name, 'name' => 'post[' . $attr->attribute_name . '][]', //				'class' => array('scroll-height'),
		...
		function render_rating_stars( $attr, $options ) {
			global $rthd_form;
			$args = array( 'id' => $attr->attribute_name, 'name' => 'post[' . $attr->attribute_name . '][]', 'class' => array( 'rthd-stars' ), 'misc' => array( 'class' => 'star', ), 'rtForm_options' => $options, );
		...
		function render_checklist( $attr, $options ) {
			global $rthd_form;
			$args = array( 'id' => $attr->attribute_name, 'name' => 'post[' . $attr->attribute_name . '][]', 'class' => array( 'scroll-height' ), 'rtForm_options' => $options, );
		...
		function render_date( $attr, $value ) {
			global $rthd_form;
			$args = array( 'id' => $attr->attribute_name, 'class' => array( 'datepicker', 'moment-from-now', ), 'misc' => array( 'placeholder' => 'Select ' . $attr->attribute_label, 'readonly' => 'readonly', 'title' => $value, ), 'value' => $value, );
		...
		function render_datetime( $attr, $value ) {
			global $rthd_form;
			$args = array( 'id' => $attr->attribute_name, 'class' => array( 'datetimepicker', 'moment-from-now', ), 'misc' => array( 'placeholder' => 'Select ' . $attr->attribute_label, 'readonly' => 'readonly', 'title' => $value, ), 'value' => $value, );
			echo $rthd_form->get_textbox( $args );
			$args = array( 'name' => 'post[' . $attr->attribute_name . ']', 'value' => $value, );
			echo $rthd_form->get_hidden( $args );
		}
