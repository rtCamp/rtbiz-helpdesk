                ...
                <div class="followup-information">
                    ...
                    <time title="<?php echo esc_attr( $post->post_date); ?>" datetime="<?php echo esc_attr( $post->post_date); ?>">
	                   <?php if ( $user_edit_content ) {
	                    ...
	                    <?php echo '<a class="followup-hash-url" id="ticket_description'.'" href="#ticket_description" >'. esc_attr( human_time_diff( strtotime( $post->post_date), current_time( 'mysql' ) ) ) . ' ago</a>';?>
                    </time>
            </div>
