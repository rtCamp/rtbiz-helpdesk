...
<div id="header-<?php echo $comment->comment_ID; ?>" class="comment-header row">
	...
	<div class="comment-meta <?php echo $class; ?>">
		...
		<div class="rthd_privacy" data-hd-privacy="<?php echo ( $rthd_privacy != 'no' ) ? 'yes' : 'no'; ?>">
		...
		<div class="comment-actions">
			<?php if ( $user_edit ) { ?>
				<a class="folowup-hover" href="#editFollowup" title="Edit"
				   data-comment-id="<?php echo $comment->comment_ID; ?>"><?php _e( 'Edit' ); ?></a>
				<a class="folowup-hover delete" href="#deleteFollowup" title="Delete"
				   data-comment-id="<?php echo $comment->comment_ID; ?>"><?php _e( 'Delete' ); ?></a>
			<?php } ?>
		</div>
	</div>
</div>
