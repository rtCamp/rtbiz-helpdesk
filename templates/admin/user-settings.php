		...
		<tr>
			<td>
				<form method="post" autocomplete="off"
				      action="<?php echo admin_url( "edit.php?post_type=" . Rt_HD_Module::$post_type . "&page=rthd-settings&tab=my-settings&type=personal" ); ?>">
					...
					<table class='hd-google-profile-table'>
						<tr valign="top">
							...
							<td class="long"><input type='text' name='mail_acl_<?php echo $rCount; ?>'
						...
						<tr valign="top">
							...
							<td class="long">
								<textarea name='emailsignature'
								          id='emailsignature'><?php echo isset( $ac->signature ) ? $ac->signature : ''; ?></textarea>
							</td>
						</tr>
						<?php if ( $ac->type == 'imap' ) { ?>
							<tr valign="top">
						...
						<tr valign="top">
							...
							<td>
								...
								<?php if ( $ac->type == 'goauth' ) { ?>
									<a class='button button-primary' href='<?php echo $authUrl; ?>'>Re Connect Google
										Now</a>
								<?php } ?>
