...
<ul class="subsubsub">
	<li>
		<a href="<?php echo admin_url( "edit.php?post_type=" . Rt_HD_Module::$post_type . "&page=rthd-settings&type=googleApi&tab=admin-settings" ); ?>" <?php if ( $_REQUEST[ "type" ] == "googleApi" ) {
			echo " class='current'";
		} ?> ><?php _e( 'Google API' ); ?></a> |
	</li>
	<li>
		<a href="<?php echo admin_url( "edit.php?post_type=" . Rt_HD_Module::$post_type . "&page=rthd-settings&type=imapServers&tab=admin-settings" ); ?>" <?php if ( $_REQUEST[ "type" ] == "imapServers" ) {
			echo " class='current'";
		} ?> ><?php _e( 'IMAP Servers' ); ?></a> |
	</li>
	<li>
		<a href="<?php echo admin_url( "edit.php?post_type=" . Rt_HD_Module::$post_type . "&page=rthd-settings&type=systememails&tab=admin-settings" ); ?>" <?php if ( $_REQUEST[ "type" ] == "systememails" ) {
			echo " class='current'";
		} ?> ><?php _e( 'System Emails' ); ?></a> |
	</li>
	<li>
		<a href="<?php echo admin_url( "edit.php?post_type=" . Rt_HD_Module::$post_type . "&page=rthd-settings&type=other&tab=admin-settings" ); ?>" <?php if ( $_REQUEST[ "type" ] == "other" ) {
			echo " class='current'";
		} ?> ><?php _e( 'Other' ); ?></a></li>
</ul>

<form method="post"
      action="<?php echo admin_url( "edit.php?post_type=" . Rt_HD_Module::$post_type . "&page=rthd-settings&tab=admin-settings&type=" . $_REQUEST[ "type" ] ); ?>">
...
<?php if ( $_REQUEST[ "type" ] == "googleApi" ) {
	...
	<tr valign="top">
		...
		<td><input type="text" name="rthd_googleapi_clientid" id="rthd_googleapi_clientid"
		           value="<?php echo get_site_option( 'rthd_googleapi_clientid' ); ?>"/>

			<p class="description">Create an app on <a target="_blank" href="https://code.google.com/apis/console">google
					api console</a>, set authorized redirect urls to
	...
	<tr valign="top">
		...
		<td><input type="text" name="rthd_googleapi_clientsecret" id="rthd_googleapi_clientsecret"
		           value="<?php echo get_site_option( 'rthd_googleapi_clientsecret' ); ?>"/></td>
	</tr>

<?php
} else {
	if ( $_REQUEST[ 'type' ] == 'imapServers' ) {
		global $rt_hd_imap_server_model;
	...
	<?php
	} elseif ( $_REQUEST[ "type" ] == "systememails" ) {
		...
		<tr valign="top">
			<th scope="row"><label
					for="<?php echo $slug; ?>_system_email"><?php echo $rt_hd_module->name . __( ' System Email' ); ?></label>
			</th>
			<td>
				<select class="rthd_system_emails" id="<?php echo $slug; ?>_system_email"
				        name="<?php echo $slug; ?>_system_email"
				        data-prev-val="<?php echo ( isset( $module_settings[ 'system_email' ] ) ) ? $module_settings[ 'system_email' ] : ''; ?>">
					...
					<?php foreach ( $allemails as $key => $e ) {
						...
						?>
						<option
							value="<?php echo $e->email; ?>" <?php echo $selected; ?>><?php echo $e->email; ?></option>
					<?php } ?>
				</select>
			</td>
			<th scope="row"><label
					for="<?php echo $slug; ?>_outbound_emails"><?php echo $rt_hd_module->name . __( ' Outbound Emails' ); ?></label>
			</th>
			<td>
				<input type="text" id="<?php echo $slug; ?>_outbound_emails" name="<?php echo $slug; ?>_outbound_emails"
				       placeholder="Comma Separated Outbound Emails"
				       value="<?php echo ( isset( $module_settings[ 'outbound_emails' ] ) ) ? $module_settings[ 'outbound_emails' ] : ''; ?>"/>
			</td>
		</tr>
		<script>
